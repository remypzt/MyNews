...
public class ResultsItemOfTopStories {
	...
	@SerializedName("item_type") private String itemType;
	
	@SerializedName("section") private String section;
	
	@SerializedName("abstract") private String jsonMemberAbstract;
	...
	@SerializedName("multimedia") private List<MultimediaItemOfTopStories> multimedia;
	
	@SerializedName("updated_date") private String updatedDate;
	...
	@SerializedName("kicker") private String kicker;
