...
public class SearchActivity extends AppCompatActivity {
	...
	private void launchTheSearch() {
		searchButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(final View v) {
				...
				bundle.putString("query", Objects
	...
	public void checkDateBetweenThem(Button button1,
		...
		if (comparison > 0 && button1 == beginbtndatepicker) {
			Toast
					.makeText(SearchActivity.this, "la date de début doit être antérieure à celle de fin", Toast.LENGTH_LONG)
					.show();
			button1.setText(null);
		} else if (comparison < 0 && button2 != endbtndatepicker) {
			Toast
					.makeText(SearchActivity.this, "la date fin doit être ultérieure à celle de début", Toast.LENGTH_LONG)
					.show();
			button1.setText(null);
	...
	public void checkDateWithToday(Date date,
		...
		if (todayCompareWithDate < 0) {
			Toast
					.makeText(SearchActivity.this, "la date sélectionnée ne peut être ultérieur à celle d'aujourd'hui", Toast.LENGTH_LONG)
					.show();
			button.setText(null);
		}
	}
