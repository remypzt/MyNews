...
public class SetNotificationsActivity extends AppCompatActivity implements View.OnClickListener {
	...
	@BindView(R.id.enable_notifications) public                Switch                           mSwitch;
	...
	@BindView(R.id.numberPickerNotificationHour) public        NumberPicker                     npHour;
	@BindView(R.id.timeSettingTextViewNotificationHour) public TextView                         timeSettingTextView;
	@BindView(R.id.numberPickerUnityFrequence) public          NumberPicker                     npFrequenceUnity;
	@BindView(R.id.timeSettingTextViewUnityFrequence) public   TextView                         frequenceUnityTextView;
	@BindView(R.id.numberPickeTypeFrequence) public            NumberPicker                     npTypeUnity;
	@BindView(R.id.timeSettingTextViewTypeFrequence) public    TextView                         typeUnityTextView;
	@BindView(R.id.switchFrequencemode) public                 Switch                           switchFrequenceMode;
	public                                                     List<String>                     listFilters;
	public                                                     Intent                           searchResultsActivity;
	public                                                     ViewModelMyNewsForSearchArticles viewModelMyNewsForSearchArticles;
	public                                                     String                           query;
	public                                                     String                           filter;
	public                                                     String                           beginDate;
	public                                                     String                           endDate;
	public                                                     String                           stringFilter;
	public                                                     String                           alertQueryTerm;
	public                                                     String                           beginDateInRightFormat;
	public                                                     String                           typeOfUnityFrequence;
	public                                                     String                           uiquery;
	public                                                     String                           uifilter;
	public                                                     String                           frequenceMode;
	public                                                     String                           alertState;
	public                                                     int                              hourOfNotification;
	public                                                     int                              delay;
	public                                                     int                              unityFrequence;
	public                                                     int                              unityFrequenceLogic;
	public                                                     Toast                            toast;
